...
PATH_TO_CKPT = os.path.join('/home/momo/Project/jurkis_ws/src/jurkis/scripts/Program/Detection/model', 'frozen_inference_graph.pb')
# List of the strings that is used to add correct label for each box.
PATH_TO_LABELS = os.path.join('/home/momo/Project/jurkis_ws/src/jurkis/scripts/Program/Detection/model/', 'mscoco_label_map.pbtxt')
# 类别数量
NUM_CLASSES = 90
